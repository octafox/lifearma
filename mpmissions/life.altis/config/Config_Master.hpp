...
/* System Settings */
    ...
    escapeMenu_displayText = "Sei uscito di prigione"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    gang_price = 450000; //Gang creation price. --Remember they are persistent so keep it reasonable to avoid millions of gangs.
    ...
    vehicle_purchase_multiplier_COP = .17; //Cop Vehicle Buy Price = Config_Vehicle price * multiplier
