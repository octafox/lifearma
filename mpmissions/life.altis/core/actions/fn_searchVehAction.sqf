...
if ((_vehicle isKindOf "Car") || !(_vehicle isKindOf "Air") || !(_vehicle isKindOf "Ship")) then {
    ...
    if (isNil "_owners") exitWith {[localize "STR_NOTF_VehCheat","info",30] call life_fnc_notification_system; deleteVehicle _vehicle;};
    ...
    if (player distance _vehicle > 10 || !alive player || !alive _vehicle) exitWith {[localize "STR_NOTF_SearchVehFail","info",30] call life_fnc_notification_system;};
