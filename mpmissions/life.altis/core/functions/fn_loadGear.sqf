...
life_maxWeight = if (backpack player isEqualTo "") then {LIFE_SETTINGS(getNumber,"total_maxWeight")} else {LIFE_SETTINGS(getNumber,"total_maxWeight") + round(M_CONFIG(getNumber,"xeCfg_backpacks",(backpack player),"vInvSize"))};
{
