...
if (_action) then {
    [localize "STR_GNOTF_DisbandGangPro","info",30] call life_fnc_notification_system;
    ...
    [localize "STR_GNOTF_DisbandGangCanc","info",30] call life_fnc_notification_system;
};