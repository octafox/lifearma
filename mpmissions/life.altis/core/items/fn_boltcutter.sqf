...
if (!(_building isKindOf "House_F")) exitWith {[localize "STR_ISTR_Bolt_NotNear","info",30] call life_fnc_notification_system;};
if (((nearestObject [_pos,"Land_Dome_Big_F"]) == _building || (nearestObject [_pos,_vaultHouse]) == _building) && (west countSide playableUnits < (LIFE_SETTINGS(getNumber,"minimum_cops")))) exitWith {
    [format [localize "STR_Civ_NotEnoughCops",(LIFE_SETTINGS(getNumber,"minimum_cops"))],"info",30] call life_fnc_notification_system;
};
