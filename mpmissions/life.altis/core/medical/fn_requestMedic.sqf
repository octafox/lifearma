...
[] spawn  {
    ((findDisplay ID_xe_deathScreen) displayCtrl ID_xe_deathScreen) ctrlEnable false;
    sleep (2 * 60);
    ((findDisplay ID_xe_deathScreen) displayCtrl ID_xe_deathScreen) ctrlEnable true;
};
