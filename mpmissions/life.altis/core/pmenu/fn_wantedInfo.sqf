...
if (isNil "_data") exitWith {[localize "STR_Cop_wantedList_FailedToFetch","info",30] call life_fnc_notification_system;};
if !(_data isEqualType []) exitWith {[localize "STR_Cop_wantedList_FailedToFetch","info",30] call life_fnc_notification_system;};
if (_data isEqualTo []) exitWith {[localize "STR_Cop_wantedList_FailedToFetch","info",30] call life_fnc_notification_system;};
