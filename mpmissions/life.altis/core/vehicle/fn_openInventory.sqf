...
if (!createDialog "TrunkMenu") exitWith {[localize "STR_MISC_DialogError","info",30] call life_fnc_notification_system;}; //Couldn't create the menu?
...
if (_veh_data select 0 isEqualTo -1) exitWith {closeDialog 0; _vehicle setVariable ["trunk_in_use",false,true]; [localize "STR_MISC_NoStorageVeh","info",30] call life_fnc_notification_system;};
